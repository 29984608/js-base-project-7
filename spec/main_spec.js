...
describe("测试描述", function(){
    ...
    it("测试用例1,9瓶啤酒", function(){

        var result = main(9);
        var expect_string = `9 bottles of beer on the wall, 9 bottles of beer.
